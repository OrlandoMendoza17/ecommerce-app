      ...
      <div className="space-y-4">
        {isLoading
          ? Array.from({ length: 4 }).map((_, index) => (
            <div
              key={index}
              className="flex items-start space-x-4 p-4 bg-muted rounded-lg animate-pulse"
            >
              <div className="shrink-0 w-12 h-12 bg-muted rounded-lg" />
          ...
          : contactMethods.map((method) => {
            ...
            const content = (
              <div className="flex items-start space-x-4 p-4 bg-muted rounded-lg hover:bg-muted transition-colors">
